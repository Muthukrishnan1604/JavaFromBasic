...
public class MobilePhone {
    ...
    public boolean addNewContact(Contact contact) {
        boolean isContactExist = (findContact(contact) >= 0);
        if(!isContactExist) {
    ...
    public boolean updateContact(Contact oldContact, Contact newContact) {
        ...
        if(contactIndex >= 0) {
           isRemoved = this.myContacts.remove(oldContact);
           this.myContacts.add(contactIndex, newContact);
           return isRemoved;
        }
        return isRemoved;
    }
