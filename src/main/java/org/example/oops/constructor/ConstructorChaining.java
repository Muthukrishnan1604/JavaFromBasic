...
public class ConstructorChaining {
    ...
    public ConstructorChaining() {
        this(56789, 100, "Divya", "Divya@gmail.com", "9003732639");
        System.out.println("Empty constructor is called");
    }

    public ConstructorChaining(int accountNumber, int accountBalance, String customerName,
