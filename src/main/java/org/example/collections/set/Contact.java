...
public class Contact {
    ...
    private static final String RETURN_VALUE = "Contact [ Name = %s, Email = %s, Phone = %s]";
    ...
    public Contact(String name, String email, long phone) {
        ...
        if(phone > 0) {
            ...
            p = PHONE_NUMBER_FORMAT.formatted(p.substring(0, 3), p.substring(3, 6), p.substring(6));
            phones.add(p);
        }
    }
    ...
    public String toString() {
        return RETURN_VALUE.formatted(name, emails, phones);
    }
    ...
    public void addEmail(String companyName) {
        ...
        if(!emails.add(email)) {
            ...
            System.out.println(name + " added into mail " + email);
        }
    }
}
